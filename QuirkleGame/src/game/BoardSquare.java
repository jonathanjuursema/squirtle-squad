...
/**
 * This class represents an layer between boards and tiles placed on these
 * boards. It offers some extra functionality related to neighbours and more
 * structured control of tiles placed on them.
 * 
...
public class BoardSquare {
	...
	/**
	 * Constructs an empty BoarDSquare in a given position and place a Tile on
	 * it.
	 * 
	 * @param board
	 *            The game board.
	...
	/**
	 * Returns a BoardSquare next to this BoardSquare in the specified
	 * direction.
	 * 
	 * @param A
	 *            direction. See the public static integers of this class.
	 * @return The BoardSquare next to the current BoardSquare in the given
	 *         direction.
	 * @throws SquareOutOfBoundsException
	 *             When a coordinate is out of range. This should never happen
	 *             though.
	 */
