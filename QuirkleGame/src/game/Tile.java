 ...
 * shape). This is also true with this implementation, because different tiles
 * with the same properties have different addresses.
 * 
...
public class Tile {
	...
	/**
	 * Returns a textual representation of the tile, in accordance with the
	 * Protocol.
	 * 
