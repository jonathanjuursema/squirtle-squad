...
public class BagTest {
	...
	@Test
	public void testAdd() throws TileNotInBagException, TooFewTilesInBagException, HandLimitReachedExeption {
		Bag bag = new Bag();
		bag.fill();
	...
	public void testInvalidSwap() throws TileNotInBagException, TooFewTilesInBagException, TooManyTilesInBag, TileNotInHandException, HandLimitReachedExeption {
		Bag bag = new Bag();
		List<Tile> tilesToAdd = new ArrayList<Tile>();
	...
	@Test
	public void testValidSwap() throws TooFewTilesInBagException, TileNotInBagException, TooManyTilesInBag, TileNotInHandException, HandLimitReachedExeption {
		Bag bag = new Bag();
		bag.fill();
	...
	@Test
	public void testEmptyBag() throws TooFewTilesInBagException, TileNotInBagException, TooManyTilesInBag, TileNotInHandException, HandLimitReachedExeption {
		Bag bag = new Bag();
		bag.fill();
	...
	public void swapMoreThenInBagTest() throws TooManyTilesInBag, HandLimitReachedExeption, TooFewTilesInBagException, TileNotInBagException, TileNotInHandException {
		Bag bag = new Bag();
	...
	@Test (expected = TooFewTilesInBagException.class)
	public void takeMoreThenInBagTest() throws TooFewTilesInBagException, TileNotInBagException, HandLimitReachedExeption {
		Bag bag = new Bag();
		Hand hand = new Hand();
		bag.takeFromBag(hand, 6);
